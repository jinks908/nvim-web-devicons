return {
  ...
  [".editorconfig"]              = { icon = "", color = "#a884ff", cterm_color = "255", name = "EditorConfig"             },
  ...
  [".prettierignore"]            = { icon = "", color = "#4ecfff", cterm_color = "33",  name = "PrettierIgnore"           },
  [".prettierrc"]                = { icon = "", color = "#4ecfff", cterm_color = "33",  name = "PrettierConfig"           },
  [".prettierrc.cjs"]            = { icon = "", color = "#4ecfff", cterm_color = "33",  name = "PrettierConfig"           },
  [".prettierrc.js"]             = { icon = "", color = "#4ecfff", cterm_color = "33",  name = "PrettierConfig"           },
  [".prettierrc.json"]           = { icon = "", color = "#4ecfff", cterm_color = "33",  name = "PrettierConfig"           },
  [".prettierrc.json5"]          = { icon = "", color = "#4ecfff", cterm_color = "33",  name = "PrettierConfig"           },
  [".prettierrc.mjs"]            = { icon = "", color = "#4ecfff", cterm_color = "33",  name = "PrettierConfig"           },
  [".prettierrc.toml"]           = { icon = "", color = "#4ecfff", cterm_color = "33",  name = "PrettierConfig"           },
  [".prettierrc.yaml"]           = { icon = "", color = "#4ecfff", cterm_color = "33",  name = "PrettierConfig"           },
  [".prettierrc.yml"]            = { icon = "", color = "#4ecfff", cterm_color = "33",  name = "PrettierConfig"           },
  ...
  [".vimrc"]                     = { icon = "", color = "#89E051", cterm_color = "28",  name = "Vimrc"                    },
  ...
  ["readme"]                     = { icon = "󰂺", color = "#ff7b72", cterm_color = "255", name = "Readme"                   },
  ["readme.md"]                  = { icon = "󰂺", color = "#ff7b72", cterm_color = "255", name = "Readme"                   },
