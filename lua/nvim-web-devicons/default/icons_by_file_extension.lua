return {
  ...
  ["ai"]             = { icon = "", color = "#ffbc00", cterm_color = "185", name = "Ai"                         },
  ...
  ["bib"]            = { icon = "󱉟", color = "#ffbc00", cterm_color = "185", name = "BibTeX"                     },
  ...
  ["cjs"]            = { icon = "", color = "#ffbc00", cterm_color = "185", name = "Cjs"                        },
  ...
  ["coffee"]         = { icon = "", color = "#ffbc00", cterm_color = "185", name = "Coffee"                     },
  ...
  ["cson"]           = { icon = "", color = "#ffbc00", cterm_color = "185", name = "Cson"                       },
  ...
  ["ejs"]            = { icon = "", color = "#ffbc00", cterm_color = "185", name = "Ejs"                        },
  ...
  ["ico"]            = { icon = "", color = "#ffbc00", cterm_color = "185", name = "Ico"                        },
  ...
  ["jpeg"]           = { icon = "", color = "#00aeff", cterm_color = "140", name = "Jpeg"                       },
  ["jpg"]            = { icon = "", color = "#00aeff", cterm_color = "140", name = "Jpg"                        },
  ["js"]             = { icon = "", color = "#ffbc00", cterm_color = "185", name = "Js"                         },
  ["json"]           = { icon = "", color = "#ffbc00", cterm_color = "185", name = "Json"                       },
  ["json5"]          = { icon = "", color = "#ffbc00", cterm_color = "185", name = "Json5"                      },
  ["jsonc"]          = { icon = "", color = "#ffbc00", cterm_color = "185", name = "Jsonc"                      },
  ["jsonl"]          = { icon = "", color = "#ffbc00", cterm_color = "185", name = "Jsonl"                      },
  ...
  ["license"]        = { icon = "", color = "#ffbc00", cterm_color = "185", name = "License"                    },
  ["liquid"]         = { icon = "", color = "#95BF47", cterm_color = "106", name = "Liquid"                     },
  ["lock"]           = { icon = "", color = "#BBBBBB", cterm_color = "250", name = "Lock"                       },
  ["log"]            = { icon = "󰌱", color = "#2fe1c8", cterm_color = "253", name = "Log"                        },
  ["lrc"]            = { icon = "󰨖", color = "#FFB713", cterm_color = "214", name = "Lrc"                        },
  ["lua"]            = { icon = "", color = "#2fe1c8", cterm_color = "74",  name = "Lua"                        },
  ["luac"]           = { icon = "", color = "#2fe1c8", cterm_color = "74",  name = "Lua"                        },
  ...
  ["markdown"]       = { icon = "", color = "#2fe1c8", cterm_color = "253", name = "Markdown"                   },
  ["material"]       = { icon = "", color = "#B83998", cterm_color = "163", name = "Material"                   },
  ["md"]             = { icon = "", color = "#2fe1c8", cterm_color = "253", name = "Md"                         },
  ...
  ["pdf"]            = { icon = "", color = "#f7768e", cterm_color = "124", name = "Pdf"                        },
  ["php"]            = { icon = "", color = "#ab66ff", cterm_color = "140", name = "Php"                        },
  ...
  ["png"]            = { icon = "", color = "#ffc933", cterm_color = "140", name = "Png"                        },
  ...
  ["rasi"]           = { icon = "", color = "#ffbc00", cterm_color = "185", name = "Rasi"                       },
  ...
  ["spec.js"]        = { icon = "", color = "#ffbc00", cterm_color = "185", name = "SpecJs"                     },
  ...
  ["test.js"]        = { icon = "", color = "#ffbc00", cterm_color = "185", name = "TestJs"                     },
  ...
  ["vim"]            = { icon = "", color = "#89E051", cterm_color = "28",  name = "Vim"                        },
